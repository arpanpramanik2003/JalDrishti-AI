...
abstract class AppLocalizations {
  ...
  /// No description provided for @aiKishanMitra.
  ///
  /// In en, this message translates to:
  /// **'JalDrishti AI Kishan-Mitra'**
  String get aiKishanMitra;
  ...
  /// No description provided for @typeOrSpeakQuery.
  ///
  /// In en, this message translates to:
  /// **'Type or speak your agricultural question...'**
  String get typeOrSpeakQuery;
  ...
  /// No description provided for @savePlot.
  ///
  /// In en, this message translates to:
  /// **'Save Plot'**
  String get savePlot;
  ...
  /// No description provided for @pestAdvisory.
  ///
  /// In en, this message translates to:
  /// **'Pest & Disease Advisory'**
  String get pestAdvisory;
}
